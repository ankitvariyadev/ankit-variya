...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      >
        <div className="h-full glass border-r border-white/10 dark:border-white/5 flex flex-col">
          {/* Logo */}
          <div className="p-6 border-b border-white/10 dark:border-white/5">
            <Link href="/admin" className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">Portfolio Manager</p>
              </div>
            </Link>
          </div>
